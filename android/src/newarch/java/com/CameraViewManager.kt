...
class CameraViewManager(reactContext: ReactApplicationContext) : ViewGroupManager<CameraView>() {
  // private val delegate: ViewGroupManagerDelegate<CameraView> = ViewGroupManagerDelegate(this)

  // override fun getDelegate(): ViewGroupManagerDelegate<CameraView> = delegate
